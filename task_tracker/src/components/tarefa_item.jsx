import {ListItem, ListItemText, Divider, IconButton, Box, Checkbox, ListItemIcon} from '@mui/material'
  ...
  return(
    <ListItem secondaryAction={
      <Box>
        ...
        <IconButton edge="end"
        aria-label="excluir tarefa" onClick={() => onDeletar(tarefa.id)}>
          <DeleteIcon />
        </IconButton>
      ...
      <ListItemText primary={tarefa.nome} secondary={`status: ${tarefa.status}`}
